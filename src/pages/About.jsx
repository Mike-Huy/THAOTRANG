        ...
        <div className="container">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            <div className="flex-1 w-full">
              ...
              <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold mb-4 uppercase text-[#008200] leading-tight">THAOTRANG GROUP - ĐA NGÀNH NGHỀ, TRỌN NIỀM TIN</h1>
              ...
              <p className="text-black mb-6 text-sm leading-relaxed">
                Với phương châm "Khách hàng là trọng tâm", mỗi dịch vụ của chúng tôi đều hướng tới sự hoàn mỹ, sang trọng và đẳng cấp quốc tế.
              </p>
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <div className="flex items-center gap-2 p-3 rounded-xl border border-[#008200]/20 bg-[#e6f3e6]/30">
                  ...
                  <div>
                    <h4 className="font-bold text-xs uppercase text-[#008200]">Sứ mệnh</h4>
                    <p className="text-[10px] text-black/70">Nâng tầm thể thao Việt</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 p-3 rounded-xl border border-[#008200]/20 bg-[#e6f3e6]/30">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 bg-[#e6f3e6] rounded-lg flex items-center justify-center text-[#008200] shrink-0">
                  ...
                  <div>
                    <h4 className="font-bold text-xs uppercase text-[#008200]">Giá trị</h4>
                    <p className="text-[10px] text-black/70">Gắn kết cộng đồng</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex-1 w-full relative mt-4 md:mt-0">
              ...
              <img
                src="https://images.unsplash.com/photo-1599586120429-48281b6f0ece?auto=format&fit=crop&q=80&w=1000"
                alt="About"
      ...
      <section className="py-6 bg-white border-t border-[#008200]/5">
        <div className="container">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8">
            {[
              { icon: <Target size={24} />, title: 'Sứ mệnh', desc: 'Xây dựng môi trường thể thao lành mạnh, chuyên nghiệp và đẳng cấp cho mọi lứa tuổi.' },
              { icon: <Users size={24} />, title: 'Tầm nhìn', desc: 'Trở thành chuỗi trung tâm cầu lông hàng đầu khu vực với chất lượng dịch vụ chuẩn quốc tế.' },
              { icon: <ShieldCheck size={24} />, title: 'Giá trị cốt lõi', desc: 'Chuyên nghiệp - Tận tâm - Sáng tạo - Kết nối cộng đồng yêu thể thao.' },
            ].map((item, idx) => (
              <motion.div
                key={idx}
                whileHover={{ y: -5 }}
      ...
      <section className="section-padding">
        <div className="container">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            {[
              { icon: <Award size={28} />, title: 'Chất lượng hàng đầu', desc: 'Hệ thống sân bãi đạt tiêu chuẩn thi đấu quốc tế, thảm sàn cao cấp chống chấn thương.' },
              { icon: <ShieldCheck size={28} />, title: 'Dịch vụ đẳng cấp', desc: 'Đội ngũ nhân viên chuyên nghiệp, tận tâm và hệ thống tiện ích đi kèm đa dạng.' },
              { icon: <Users size={28} />, title: 'Cộng đồng văn minh', desc: 'Nơi giao lưu của những người yêu thể thao chân chính và các doanh nhân thành đạt.' },
            ].map((item, idx) => (
