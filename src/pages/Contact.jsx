        ...
        <div className="container px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1 grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-3 sm:gap-4">
              {[
                { icon: <MapPin size={20} />, title: 'Địa chỉ', content: '123 Đường Cầu Lông, Quận 7, TP. Hồ Chí Minh' },
                { icon: <Phone size={20} />, title: 'Hotline', content: '090 123 4567', sub: 'Phục vụ 24/7' },
                { icon: <Mail size={20} />, title: 'Email', content: 'contact@thaotrang.vn' },
              ].map((item, idx) => (
                <motion.div
                  key={idx}
                  whileHover={{ x: 5 }}
              ...
              <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-[#008200]/20">
                ...
                <form className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input type="text" className="px-4 sm:px-5 py-3 rounded-xl bg-gray-50 border border-[#008200]/20 focus:ring-1 focus:ring-[#008200] focus:bg-white outline-none text-xs transition-all" placeholder="Nguyễn Văn A" />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-black uppercase tracking-wider">Số điện thoại *</label>
                    <input type="tel" className="px-4 sm:px-5 py-3 rounded-xl bg-gray-50 border border-[#008200]/20 focus:ring-1 focus:ring-[#008200] focus:bg-white outline-none text-xs transition-all" placeholder="090..." />
                  </div>
                  <div className="flex flex-col gap-1.5 sm:col-span-2">
                    <label className="text-[10px] font-bold text-black uppercase tracking-wider">Email</label>
                    <input type="email" className="px-4 sm:px-5 py-3 rounded-xl bg-gray-50 border border-[#008200]/20 focus:ring-1 focus:ring-[#008200] focus:bg-white outline-none text-xs transition-all" placeholder="example@gmail.com" />
                  </div>
                  <div className="flex flex-col gap-1.5 sm:col-span-2">
                    <label className="text-[10px] font-bold text-black uppercase tracking-wider">Nội dung tin nhắn</label>
                    <textarea rows="4" className="px-4 sm:px-5 py-3 rounded-xl bg-gray-50 border border-[#008200]/20 focus:ring-1 focus:ring-[#008200] focus:bg-white outline-none resize-none text-xs transition-all" placeholder="Bạn cần tư vấn về vấn đề gì?"></textarea>
                  </div>
                  <div className="sm:col-span-2">
                    <button className="w-full bg-[#008200] text-white py-3 rounded-xl font-bold hover:bg-[#00a300] transition-all shadow-lg text-xs uppercase tracking-widest">
                      GỬI TIN NHẮN NGAY
                    </button>
                  </div>
                </form>
          ...
          <div className="mt-8 sm:mt-12 h-48 sm:h-64 w-full rounded-2xl overflow-hidden shadow-sm relative grayscale hover:grayscale-0 transition-all duration-700 border border-gray-100">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.954415523533!2d106.6919702758368!3d10.73800245989824!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f9708709a39%3A0xc48c9735d46816a7!2zMTIzIMSQxrDhu51uZyBD4bqndSBMw7RuZywgUXXhuq1uIDcsIFRow6BuaCBwaOG7kSBI4buTIENow60gTWluaCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1714800000000!5m2!1svi!2s"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
